...
import spritesheets from "../assets/spritesheets/*.png";
import tilesets from "../assets/tilesets/*.png";
import TILES from "./tile-mapping";
import Dungeon from "@mikewesthad/dungeon";
import TilemapVisibility from "./tilemap-visability";
...
export default class DungeonScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image("tiles", tilesets.dungeonTileSet);
    this.load.spritesheet("characters", spritesheets.playerSpriteSheet, {
      frameWidth: 64,
      frameHeight: 64,
      margin: 1,
      spacing: 2,
